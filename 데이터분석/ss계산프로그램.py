...
def calculate():
  ...
  ssa3 = (dry_a3-first_a3)/10*(10**6)
  vssa1 = (dry_a1-burn_a1)/10*(10**6)
  vssa2 = (dry_a2-burn_a2)/10*(10**6)
  vssa3 = (dry_a3-burn_a3)/10*(10**6)
  #막분리 계산
  ssm1 = (dry_m1-first_m1)/10*(10**6)
  ssm2 = (dry_m2-first_m2)/10*(10**6)
  ssm3 = (dry_m3-first_m3)/10*(10**6)
  vssm1 = (dry_m1-burn_m1)/10*(10**6)
  vssm2 = (dry_m2-burn_m2)/10*(10**6)
  vssm3 = (dry_m3-burn_m3)/10*(10**6)
...
lb_text1 = ttk.Label(root, text = "SS VSS 계산기",  foreground= 'orange', font = 'helvetica 16 bold')
...
lb1_a = ttk.Label(root, text = '처음무개_전폭기1번')
lb2_a = ttk.Label(root, text = '처음무개_전폭기2번')
lb3_a = ttk.Label(root, text = '처음무개_전폭기3번')
lb4_a = ttk.Label(root, text = '건조무개_전폭기1번')
lb5_a = ttk.Label(root, text = '건조무개_전폭기2번')
lb6_a = ttk.Label(root, text = '건조무개_전폭기3번')
lb7_a = ttk.Label(root, text = '태운무개_전폭기1번')
lb8_a = ttk.Label(root, text = '태운무개_전폭기2번')
lb9_a = ttk.Label(root, text = '태운무개_전폭기3번')
...
lb1_m = ttk.Label(root, text = '처음무개_막분리1번')
lb2_m = ttk.Label(root, text = '처음무개_막분리2번')
lb3_m = ttk.Label(root, text = '처음무개_막분리3번')
lb4_m = ttk.Label(root, text = '건조무개_막분리1번')
lb5_m = ttk.Label(root, text = '건조무개_막분리2번')
lb6_m = ttk.Label(root, text = '건조무개_막분리3번')
lb7_m = ttk.Label(root, text = '태운무개_막분리1번')
lb8_m = ttk.Label(root, text = '태운무개_막분리2번')
lb9_m = ttk.Label(root, text = '태운무개_막분리3번')
...
lbra1.place(x=5, y=300)
lbra2.place(x=5, y=350)
lbrm1.place(x=250, y=300)
lbrm2.place(x=250, y=350)

ent_rass =  ttk.Entry(root)
ent_ravss = ttk.Entry(root)
ent_rmss = ttk.Entry(root)
ent_rmvss = ttk.Entry(root)
ent_rass.place(x=65, y=300)
ent_ravss.place(x=65, y=350)
ent_rmss.place(x=315, y=300)
ent_rmvss.place(x=315, y=350)
...
scales1.place(x=215, y=300)
scales2.place(x=215, y=350)
scales3.place(x=460, y=300)
scales4.place(x=460, y=350)
